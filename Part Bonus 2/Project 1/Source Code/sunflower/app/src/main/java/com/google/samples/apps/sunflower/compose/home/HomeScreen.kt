...
// Class representing a page in the home screen
...
fun HomeScreen(
    ...
    val pagerState = rememberPagerState(pageCount = { pages.size }) // State for managing the pager
    val scrollBehavior = TopAppBarDefaults.enterAlwaysScrollBehavior() // Scroll behavior for the app bar

    // Scaffold with the home screen content
    Scaffold(
        modifier = modifier.nestedScroll(scrollBehavior.nestedScrollConnection),
        topBar = {
            // Display the home top app bar
            HomeTopAppBar(
        ...
        // Display horizontal pager for the home screen content
        HomePagerScreen(
...
// Composable function for horizontal pager screen
...
fun HomePagerScreen(
    ...
    Log.d("HomePagerScreen", "HomePagerScreen composable called")
    // Column to hold the pager and tabs
    Column(modifier) {
        ...
        HorizontalPager(
            ...
            when (pages[index]) {
                SunflowerPage.MY_GARDEN -> {
                    Log.d("HomePagerScreen", "My Garden composable called")
                    // Display garden screen
                    GardenScreen(
                ...
                SunflowerPage.PLANT_LIST -> {
                    Log.d("HomePagerScreen", "Plant List composable called")
                    // Display plant list screen
                    PlantListScreen(
                        onPlantClick = onPlantClick,
...
// Composable for the home top app bar
...
private fun HomeTopAppBar(
    ...
    Log.d("HomeTopAppBar", "HomeTopAppBar composable called")
    // Center-aligned top app bar with the app name and filter icon
    CenterAlignedTopAppBar(
        title = {
            Log.d("HomeTopAppBar", "Title composable called")
                Text(
        ...
        actions = {
            if (pagerState.currentPage == SunflowerPage.PLANT_LIST.ordinal) {
                Log.d("HomeTopAppBar", "Filter icon composable called")
