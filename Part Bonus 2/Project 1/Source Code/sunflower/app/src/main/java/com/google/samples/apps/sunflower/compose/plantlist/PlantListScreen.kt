...
// PlantListScreen composable to display a list of plants
@Composable
fun PlantListScreen(
    ...
    Log.d("PlantListScreen", "PlantListScreen called")
...
fun PlantListScreen(
    ...
    Log.d("PlantListScreen", "PlantListScreen called")
    // Use a LazyVerticalGrid to display a list of plants
    LazyVerticalGrid(
        ...
        // Use items to populate grid with plant data
        items(
            items = plants,
            key = { it.plantId } // Use plant id as key for items
        ) { plant ->
            // Display a PlantListItem for each plant
            PlantListItem(plant = plant) {
                Log.d("PlantListScreen", "PlantListItem clicked")
                onPlantClick(plant) // Call onPlantCLick callback
            }
        }
    }
}

// Preview for PlantListScreen
@Preview
@Composable
