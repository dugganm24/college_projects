...
// Composable function for Gallery screen
@Composable
fun GalleryScreen(
    ...
    Log.d("GalleryScreen", "GalleryScreen composable called")
    // Display gallery screen content
    GalleryScreen(
...
private fun GalleryScreen(
    ...
    Scaffold(
        ...
        Box(
            ...
            // Display pull-to-refresh indicator
...
// Composable for the gallery top bar
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun GalleryTopBar(
    ...
    Log.d("GalleryTopBar", "GalleryTopBar composable called")
    // Display gallery top bar
    TopAppBar(
        title = {
