...
// Composable function for the garden screen
@Composable
fun GardenScreen(
...
// Composable function for the garden screen content
@Composable
fun GardenScreen(
    ...
    if (gardenPlants.isEmpty()) {
        Log.d("GardenScreen", "Garden is empty")
        EmptyGarden(onAddPlantClick, modifier) // Display empty garden content
    }
    // Otherwise, display the garden list
    else {
        Log.d("GardenScreen", "Garden is not empty")
        GardenList(gardenPlants = gardenPlants, onPlantClick = onPlantClick, modifier = modifier)
    }
}

// Composable function for the Garden list
@Composable
private fun GardenList(
    ...
    Log.d("GardenList", "GardenList composable called")
...
// Composable function for a garden list item
@Composable
private fun GardenListItem(
    plant: PlantAndGardenPlantings,
    onPlantClick: (PlantAndGardenPlantings) -> Unit
) {
    Log.d("GardenListItem", "GardenListItem composable called")
...
// Composable function for an empty garden
@Composable
private fun EmptyGarden(onAddPlantClick: () -> Unit, modifier: Modifier = Modifier) {
    Log.d("EmptyGarden", "EmptyGarden composable called")
...
// Preview composable for the garden screen
@Preview
@Composable
